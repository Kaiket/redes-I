...
#define ERROR_ETH 5 /*Indica que un paquete no pasa el filtro de direcciones MAC*/
 ...
 * Recibe: Puntero a la cabecera ETH del paquete, Puntero a cabecera IP del paquete, puntero a cabecera de tranporte
