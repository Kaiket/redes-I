...
/****************************************************************************************
 * Nombre: ARPrequest									*
 * Descripcion: Devuelve la direccion Ethernet dada una direccion IP			*
 * Argumentos: 										*
 ...
 * Descripcion: Devuelve la direccion Ethernet de una interface				*
 * Argumentos: 										*
 ...
 * Descripcion: Devuelve la mascara de red de una interface				*
 * Argumentos: 										*
 *  -interface: la interface sobre la que se pregunta  					*
 ...
 * Descripcion: Devuelve la MTU del nivel anterio al fisco (enlace)			*
 * Argumentos: 										*
 *  -interface: la interface sobre la que se pregunta  					*
 ...
 * Descripcion: Esta funcion devuelve la IP asignada a una interface			*
 * Argumentos: 										*
 ...
 * Descripcion: Esta funcion devuelve el gateway dada una interface 			*
 * Argumentos: 										*
 *  -interface: nombre de la interface (ej: eth0)					*
